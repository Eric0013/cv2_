...
def main():
    ...
    perfect_top_layer = [
        {'box': (58 - 9, 62 - 9, 58 + 9, 62 + 9), 'center': (58, 62)},    
        {'box': (168 - 9, 68 - 9, 168 + 9, 68 + 9), 'center': (168, 68)}, 
        {'box': (273 - 9, 75 - 9, 273 + 9, 75 + 9), 'center': (273, 75)}  
    ]
    ...
    if len(bottom_layer) < 3:
        ...
        standard_bottom = [
            {'box': (68 - 25, 254 - 30, 68 + 25, 254 + 30), 'center': (68, 254)}, 
            {'box': (175 - 25, 254 - 30, 175 + 25, 254 + 30), 'center': (175, 254)}, 
            {'box': (275 - 25, 254 - 30, 275 + 25, 254 + 30), 'center': (275, 254)}
        ]
